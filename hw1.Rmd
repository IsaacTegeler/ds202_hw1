...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    My name is **Isaac Tegeler**. I am a *Computer Engineering* student. This is my last semester. My career goals are focused around develping perception based systems. I like to rock climb, hike, and cook in my free time.
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Working with vision systems is related to data science. There is no way to verify the system without collecting real world data and evaluating on how the vision system performs on that data. Deep learning is a popular technique to create vision systems, since deep learning is a machine learning technique it involves data science.
    Result of a perception system from: [Blue River](http://www.bluerivertechnology.com/)
    ![SeeAndSpray](SeeAndSpray.webp)
  
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    [Agriculture Data](https://www.ars.usda.gov/research/datasets/)
...
10. Register a [GitHub](https://www.github.com) account. What is your username?
    ...
    [IsaacTegeler](https://github.com/IsaacTegeler)
